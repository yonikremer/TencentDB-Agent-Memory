...
export class CoreSkillClient {
 ...
 constructor(
  config: Pick<
   CoreSkillConfig,
   "endpoint" | "serviceToken" | "serviceId" | "timeoutMs"
  >,
 ...
 async extractSkill(
  ...
  | ExtractAsyncResult
  | { cached: boolean; cache_key: string; candidates: unknown[] }
 > {
 ...
 async addConversation(
  ...
  return this.post<ConversationAddResult>(
 ...
 async forceArchive(
  ...
  return this.post<ForceArchiveResponse>(
