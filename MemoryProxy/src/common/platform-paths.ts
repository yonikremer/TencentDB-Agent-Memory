 ...
 *
 * NOTE: object-storage keys (ProxyStorage / kv repos) are NOT filesystem
 * paths — they always use forward slashes. Use normalizeStorageKey() for
 * those; use path.join/resolve/isPathInside() for real filesystem paths.
 */
