 ...
 *
 * Decouples SkillCore / SkillVersioning from storage implementation.
 * SqliteSkillStore implements this interface; consumers rely solely on it.
 *
 * Design documents:
...
export interface SkillStoreCapabilities {
 ...
 ftsSearch: boolean;
 /** Native hybridSearch available (false for sqlite local mode) */
