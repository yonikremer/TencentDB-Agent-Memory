...
export type OpenClawRuntimeConfig = Record<string, unknown>;
function narrowRuntimeConfig(v: unknown): OpenClawRuntimeConfig | undefined {
...
export class OpenClawHostAdapter implements HostAdapter {
 ...
 private openclawConfig: OpenClawRuntimeConfig | undefined;
 ...
 constructor(opts: OpenClawHostAdapterOptions) {
  ...
  this.openclawConfig = narrowRuntimeConfig(opts.openclawConfig);
